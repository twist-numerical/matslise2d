...
namespace matslise {
    ...
    class Matslise3DSector : public MatsliseNDSector<Scalar_> {
    public:
        using typename MatsliseNDSector<Scalar_>::Scalar;
        ...
        Matslise3DSector<Scalar_> *
        refine(const Matslise3D<Scalar> *problem, const Scalar &min, const Scalar &max, Direction) const;
    };

    template<typename Scalar_=double>
    class Matslise3D : public AbstractMatslise3D<Scalar_>, private MatsliseND<Scalar_, Matslise3DSector<Scalar_>> {
    public:
